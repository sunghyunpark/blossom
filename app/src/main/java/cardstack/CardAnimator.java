...
import cardstack.animation.RelativeLayoutParamsEvaluator;

import static cardstack.CardUtils.cloneParams;
import static cardstack.CardUtils.getMoveParams;
import static cardstack.CardUtils.move;
import static cardstack.CardUtils.scale;
...
public class CardAnimator {
    ...
    public void initLayout() {
        ...
        for (View v : mCardCollection) {
            ...
            RelativeLayout.LayoutParams params = cloneParams(baseLayout);
            v.setLayoutParams(params);
